...
{
    internal static string BuildFullAssemblyName(this AssemblyNameReference assemblyNameReference)
    {
        ...
        return $"{assemblyNameReference.Name}, Version={assemblyNameReference.Version}, Culture={culture}, PublicKeyToken={publicKey}";
    }
